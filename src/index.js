...
import ApproachBusinessToolsPage from "./pages/approach-business-tools-page/main";
import ValuesAndSkillsPage from "./pages/values-skills-page/main";
    ...
    <Router>
        <StyleWrapper>
            ...
            <Routes>
                ...
                <Route key={"3"} path="/approach-and-business-tools" element={<ApproachBusinessToolsPage/>}/>
                ...
                <Route key={"8"} path="/values-and-skills" element={<ValuesAndSkillsPage/>}/>
            </Routes>
        </StyleWrapper>
    </Router>
);